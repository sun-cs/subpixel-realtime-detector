...
#define IDC_PIXEL_FORMAT_EDIT           1028
#define IDC_AUXILIARY_LINE_DRAWING_STATIC 1029
#define IDC_CIRCLE_AUXILIARY_BUTTON     1030
#define IDC_LINES_AUXILIARY_BUTTON      1031
